...
::content::
Esta sesión aborda el tema **Estructura básica de una Open Class** desde una perspectiva aplicada, académica y profesional.
...
1. Reconocer los conceptos principales asociados con **Estructura básica de una Open Class**.
...
tema = "Estructura básica de una Open Class"
actividad = "Revisar la estructura generada y probar la presentación"
...
::content::
**Revisar la estructura generada y probar la presentación**
